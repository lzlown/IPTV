...
import com.lzlown.iptv.videoplayer.player.VideoViewManager;
...
public class ExoPlayer extends AbstractPlayer implements Player.Listener {
    ...
    protected ExoSourceHelper mMediaSourceHelper;
    ...
    public ExoPlayer(Context context) {
        ...
        mMediaSourceHelper = ExoSourceHelper.getInstance(context);
    }
    ...
    public void onPlaybackStateChanged(int playbackState) {
        ...
        DebugLog.i(TAG,"onPlaybackStateChanged "+playbackState);
