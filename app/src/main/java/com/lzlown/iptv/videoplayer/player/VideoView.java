package com.lzlown.iptv.videoplayer.player;
...
import com.lzlown.iptv.videoplayer.controller.MediaPlayerControl;
import com.lzlown.iptv.videoplayer.render.IRenderView;
        ...
        switch (what) {
            ...
            case AbstractPlayer.MEDIA_INFO_RENDERING_START: // 视频/音频开始渲染
                ...
                for (int i = 0; i < views.size(); i++) {
                    mPlayerContainer.removeView(views.remove(i)); ;
                }
                break;
