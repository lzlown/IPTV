package com.lzlown.iptv.util.live;
                    ...
                    if (split.length < 2) {
                        ...
                        if (readLine.contains("#genre#")) {
                            ...
                            for (String str2 : split[2].trim().split("#")) {
                                ...
                                if (!trim3.isEmpty() && (trim3.startsWith("http") || trim3.startsWith("rtp") || trim3.startsWith("rtsp") || trim3.startsWith("rtmp")|| trim3.startsWith("proxy"))) {
