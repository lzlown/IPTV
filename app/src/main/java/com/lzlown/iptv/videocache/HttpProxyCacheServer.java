...
public class HttpProxyCacheServer {
    private static final String TAG = HttpProxyCacheServer.class.getName();
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            Log.i(TAG, "HttpProxyCacheServer: ");
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                Log.e(TAG, "Error registering cache listener", e);
            }
        }
    }
    ...
    private void waitForRequest() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                Log.i(TAG, "Accept new socket " + socket);
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            if (pinger.isPingRequest(url)) {
                ...
                Log.i(TAG, "Request to cache proxy: socket1");
            }
    ...
    private void closeSocketInput(Socket socket) {
        try {
            ...
            Log.d(TAG, "Error closing socket input stream");
        }
    }
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            Log.w(TAG, "Failed to close socket on proxy side: {}. It seems client have already closed connection.");
        }
    }
    ...
    private void onError(Throwable e) {
        Log.e(TAG, "HttpProxyCacheServer error", e);
    }
    ...
    public static final class Builder {
        ...
        private Config buildConfig() {
            return new Config(sourceInfoStorage, headerInjector);
        }
